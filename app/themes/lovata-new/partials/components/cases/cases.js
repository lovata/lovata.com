...
export default new class CaseSlider {
  constructor () {
    this.screenSlide = 1023;
    this.screen = null;
    this.slider = null;
    this.init();
  }
  ...
  initSlider () {
    return new Swiper(document.querySelector(".js-slider-cases"), {
      modules: [Pagination],
      spaceBetween: 16,
      slidesPerView: 2.5,
      breakpoints: {
      ...
      pagination: {
        el: document.querySelector('.js-slider-cases-bullets'),
        type: 'bullets',
