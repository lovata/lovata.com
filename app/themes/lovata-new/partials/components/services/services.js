...
export default new class servicesSlider {
  constructor () {
    this.screenSlide = 767;
    this.screen = null;
    this.slider = null;
    this.init();
  }
  ...
  initSlider () {
    return new Swiper(document.querySelector(".js-slider-services"), {
      modules: [Pagination],
      spaceBetween: 16,
      slidesPerView: 2.5,
      breakpoints: {
      ...
      pagination: {
        el: document.querySelector('.js-slider-services-bullets'),
        type: 'bullets',
